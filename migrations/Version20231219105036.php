 ...
 */
final class Version20231219105036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE affectation (id INT AUTO_INCREMENT NOT NULL, service_departemental_id INT NOT NULL, poste_id INT NOT NULL, date_affectation DATE NOT NULL, INDEX IDX_F4DD61D36DC6ADBB (service_departemental_id), INDEX IDX_F4DD61D3A0905086 (poste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE volontaire CHANGE telephone telephone VARCHAR(9) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE volontaire CHANGE telephone telephone VARCHAR(255) NOT NULL');
    }
}
